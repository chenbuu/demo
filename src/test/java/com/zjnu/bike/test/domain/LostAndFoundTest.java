...
public class LostAndFoundTest {
	...
	public void save() throws Exception {
		...
		List<LostAndFound> cList = new ArrayList<LostAndFound>();
		...
		for (int i = 0; i < 100; i++) {
			LostAndFound m = new LostAndFound();
		...
		this.lostAndFoundRepository.save(cList);
		System.out.println("-------------------------------");
	}
	...
	public void findAll() throws Exception {
		...
		for (LostAndFound model : this.lostAndFoundRepository.findAll()) {
			log.debug("{}", model);
		}
		System.out.println("-------------------------------");
	}
