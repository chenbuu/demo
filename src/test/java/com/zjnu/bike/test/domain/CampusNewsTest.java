...
public class CampusNewsTest {
	...
	public void save() throws Exception {
		...
		List<CampusNews> cList = new ArrayList<CampusNews>();
		...
		this.campusNewsRepository.save(cList);
		System.out.println("-------------------------------");
	}
	...
	public void findAll() throws Exception {
		...
		for (CampusNews model : this.campusNewsRepository.findAll()) {
			log.debug("{}", model);
		}
		System.out.println("-------------------------------");
	}
