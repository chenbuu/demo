...
public class DrivingSchoolTest {
	...
	public void save() throws Exception {
		...
		List<DrivingSchool> cList = new ArrayList<DrivingSchool>();
		...
		for (int i = 0; i < 100; i++) {
			DrivingSchool m = new DrivingSchool();
		...
		this.drivingSchoolRepository.save(cList);
		System.out.println("-------------------------------");
	}
	...
	public void findAll() throws Exception {
		...
		for (DrivingSchool model : this.drivingSchoolRepository.findAll()) {
			log.debug("{}", model);
		}
		System.out.println("-------------------------------");
	}
