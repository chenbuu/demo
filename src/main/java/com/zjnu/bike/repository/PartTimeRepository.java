...
import com.zjnu.bike.domain.QPartTime;

public interface PartTimeRepository extends BaseRepository<PartTime, String> {

	default Page<PartTime> findAll(@Valid PartTime mod, Pageable pageable) {
		if (mod == null) {
			return findAll(pageable);
		}
		BooleanBuilder builder = new BooleanBuilder();
		QPartTime q = QPartTime.partTime;
