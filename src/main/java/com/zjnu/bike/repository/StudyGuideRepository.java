...
import com.zjnu.bike.domain.QStudyGuide;
import com.zjnu.bike.domain.StudyGuide;

public interface StudyGuideRepository extends BaseRepository<StudyGuide, String> {

	default Page<StudyGuide> findAll(@Valid StudyGuide mod, Pageable pageable) {
		if (mod == null) {
			return findAll(pageable);
		}
		BooleanBuilder builder = new BooleanBuilder();
		QStudyGuide q = QStudyGuide.studyGuide;
