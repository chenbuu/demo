...
import com.zjnu.bike.domain.QLifeGuide;

public interface LifeGuideRepository extends BaseRepository<LifeGuide, String> {

	default Page<LifeGuide> findAll(@Valid LifeGuide mod, Pageable pageable) {
		if (mod == null) {
			return findAll(pageable);
		}
		BooleanBuilder builder = new BooleanBuilder();
		QLifeGuide q = QLifeGuide.lifeGuide;
